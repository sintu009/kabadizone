...
import { LogOut, Phone, MapPin, Star, IndianRupee } from 'lucide-react';
...
const ProfilePage = () => {
  ...
  const { balance, pickups } = useSelector((s) => s.scrapboyWallet);
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm divide-y divide-gray-100">
        {[
          { label: t('scrapboy.areaAssigned'), value: 'Sector 5, MG Road' },
          { label: t('scrapboy.totalPickups'), value: String(completedCount) },
          { label: t('scrapboy.memberSince'), value: 'Jan 2025' },
        ].map((item) => (
